...
import { X, Key, Eye, Clock, Sliders, Palette } from "lucide-react";
...
const THEMES: {
  name: string;
  value: "light" | "dark" | "sepia";
  swatch: string;
}[] = [
  { name: "Light", value: "light", swatch: "#f8fafc" },
  { name: "Dark", value: "dark", swatch: "#0f172a" },
  { name: "Sepia", value: "sepia", swatch: "#fdf6e3" },
];
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1 text-sm">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400">
              Get an API key from the Google AI Studio. Your key is stored
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("dwellTime", parseInt(e.target.value))
                }
                className="w-full accent-indigo-500"
              />
              <p className="text-xs text-slate-400 mt-1">
                How long the mouse cursor must pause over a paragraph before the
                AI agent intervenes with reading scaffolding.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    updateField("rulerEnabled", e.target.checked)
                  }
              ...
              <div className="space-y-3 pl-2 border-l border-slate-100 dark:border-slate-800 animate-fadeIn">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("rulerHeight", parseInt(e.target.value))
                    }
                    className="w-full accent-indigo-500"
                  />
                </div>
